...
-- Custom: replace spaces with tabs
...
vim.keymap.set('n', '<leader>i', 'O<Esc>o', { desc = 'Insert line above and below and enter edit mode' })

-- configure terminal shell
vim.o.shell = '/bin/bash --login'

-- automatically save the current session when leaving vim
local session_path = vim.fn.stdpath 'state' .. '/last-session.vim'
